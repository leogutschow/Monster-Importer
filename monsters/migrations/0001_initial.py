...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basesheet_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='monsters.basesheet')),
                ('monster_class', models.CharField(blank=True, default='', max_length=25, null=True)),
                ('monster_alignment', models.CharField(choices=[('LG', 'Lawful Good'), ('LN', 'Lawful Neutral'), ('LE', 'Lawful Evil'), ('NG', 'Neutral Good'), ('N', 'Neutral'), ('CN', 'Chaotic Neutral'), ('CG', 'Chaotic Good'), ('CN', 'Chaotic Neutral'), ('CE', 'Chaotic Evil')], default='N', max_length=30)),
                ('type', models.CharField(max_length=20)),
                ('subtype', models.CharField(blank=True, max_length=50, null=True)),
                ('init', models.CharField(max_length=20)),
                ('senses', models.CharField(blank=True, max_length=100, null=True)),
                ('aura', models.CharField(blank=True, max_length=50, null=True)),
                ('ac_mod', models.CharField(blank=True, max_length=100, null=True)),
                ('hp_mod', models.CharField(blank=True, max_length=100, null=True)),
                ('fortitude', models.IntegerField()),
                ('reflex', models.IntegerField()),
                ('will', models.IntegerField()),
                ('save_mods', models.CharField(blank=True, max_length=100, null=True)),
                ('damage_reduction', models.CharField(blank=True, max_length=50, null=True)),
                ('immune', models.CharField(blank=True, max_length=50, null=True)),
                ('resist', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('special_qualities', models.CharField(blank=True, max_length=100, null=True)),
